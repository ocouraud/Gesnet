object FormFactureMemPrint: TFormFactureMemPrint
  Left = 0
  Top = 0
  ...
  object DSEntvteaa: TDataSource
    DataSet = FDMemTableEntvte
    Left = 40
    Top = 670
  end
  object DSLigvteaa: TDataSource
    DataSet = FDMemTableLigvte
    Left = 120
    Top = 670
  end
  object DSReglaa: TDataSource
    DataSet = FDMemTableRegl
    Left = 200
    Top = 670
  end
  ...
  object FDMemTableEntvte: TFDMemTable
  ...
  object FDMemTableLigvte: TFDMemTable
    FetchOptions.AssignedValues = [evMode]
    FetchOptions.Mode = fmAll
    ResourceOptions.AssignedValues = [rvSilentMode]
    ResourceOptions.SilentMode = True
  ...
  object FDMemTableRegl: TFDMemTable
    FetchOptions.AssignedValues = [evMode]
    FetchOptions.Mode = fmAll
    ResourceOptions.AssignedValues = [rvSilentMode]
    ResourceOptions.SilentMode = True
  ...
  object FDQueryClient: TFDQuery
    ...
    SQL.Strings = (
      'select * from client where codcli=:codcli')
    Left = 230
    Top = 651
    ParamData = <
      item
