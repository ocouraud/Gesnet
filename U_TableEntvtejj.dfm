object FrameTableEntvtejj: TFrameTableEntvtejj
  ...
  object FDQueryFacture: TFDQuery
    ...
    SQL.Strings = (
      ...
      'JOIN ligvtejj l ON e.CODFAC = l.CODFAC'
    ...
    object FDQueryFactureTOP_: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'TOP_'
      Origin = 'TOP_'
      Size = 1
    ...
    object FDQueryFactureSEL: TSmallintField
      AutoGenerateValue = arDefault
      FieldName = 'SEL'
      Origin = 'SEL'
    end
    ...
    object FDQueryFactureSELECT_: TBooleanField
      AutoGenerateValue = arDefault
      FieldName = 'SELECT_'
      Origin = 'SELECT_'
      ProviderFlags = []
  ...
  object frxReportFacture: TfrxReport
    ...
    ScriptText.Strings = (
      ...
      ''
      'end.')
    OnBeforePrint = frxReportFactureBeforePrint
    Left = 416
    Top = 152
    Datasets = <
      item
  ...
  object FDQueryReglements: TFDQuery
    ...
    Connection = DMGesCloud.ConnexionGesCloud
    SQL.Strings = (
      'select * from regljj where codfac=:codfac')
    Left = 200
    Top = 208
    ParamData = <
      item
