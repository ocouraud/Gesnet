object FormEnt_prof: TFormEnt_prof
  Left = 0
  Top = 0
  ...
  object FDMemTableEnt_prof: TFDMemTable
    FieldDefs = <>
    IndexDefs = <>
  ...
  object DSMemTableEnt_prof: TDataSource
    DataSet = FDMemTableEnt_prof
    Left = 608
    Top = 424
  end
  object FDMemTableLig_prof: TFDMemTable
    FetchOptions.AssignedValues = [evMode]
    FetchOptions.Mode = fmAll
    ResourceOptions.AssignedValues = [rvSilentMode]
    ResourceOptions.SilentMode = True
  ...
  object DSMemTableLig_prof: TDataSource
    DataSet = FDMemTableLig_prof
    Left = 504
    Top = 328
  end
